...
function init() {
    ...
    var myLatlng = new google.maps.LatLng(18.8063775, -98.6238173);
    ...
    var addresses = ['San Francisco Xochiteopan'];

    for (var x = 0; x < addresses.length; x++) {
        var latlng = new google.maps.LatLng(18.8063775, -98.6238173);
